    ...
    return (
        <Area className="bg-black py-20">
            ...
            <div className="flex flex-col md:flex-row md:justify-between items-center mt-14">
                ...
                <Link href="https://moser-portifolio.netlify.app" target="_blank">
                    <span className="font-bold">M<span className="text-red-500 text-lg">O</span>SER</span> ® {new Date().getFullYear()} - Todos os direitos reservados
                </Link>
                </p>
            </div>
        </Area>
